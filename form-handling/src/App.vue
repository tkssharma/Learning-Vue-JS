    ...
    <form @submit.prevent="validateBeforeSubmit" v-if="!formSubmitted">
        ...
        <div class="form-group"
         :class="{'has-error': errors.has('name') }">
            ...
            <input v-model="name" v-validate.initial="name" data-rules="required|alpha|min:3" 
        ...
        <div class="form-group" :class="{'has-error': errors.has('email') }" >
            ...
            <input v-model="email" v-validate.initial="email" data-rules="required|email" 
...
VeeValidate.Validator.extend("passphrase", {
  ...
  validate: value => value.toUpperCase() == "hellodemo".toUpperCase()
});
